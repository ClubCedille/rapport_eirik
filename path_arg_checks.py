...
def check_generable_path(
	...
	path is formed with the current working directory and the default file
	name. If the checked path points to a directory, this function appends the
	default file name to it to generate a usable file path.
